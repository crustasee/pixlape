...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="flex flex-col w-full h-full lg:h-auto md:w-80 shrink-0 gap-3 md:sticky md:top-26 md:h-fit" role="complementary" aria-label="Sidebar filters">
      {/* ================================================== CATEGORIES SECTION =================================================*/}
