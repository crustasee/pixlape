...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-soft-linen p-4 font-mono admin-grid-bg">
      <div className="max-w-md w-full bg-yellow-green text-darkteal border border-border-color rounded-2xl p-6 sm:p-8 shadow-hard-lg relative overflow-hidden">
        {/* Brand Header */}
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs font-mono font-bold text-darkteal mt-1">
            ADMINISTRATOR ENTRY GATEWAY NOT FOR PUBLIC
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-mono font-black uppercase text-darkteal mb-1.5">
              ●●● Email
            </label>
            <input
              type="email"
              ...
              className="w-full px-3.5 py-2.5 bg-yellow-100 text-evergreen border-2 border-border-color rounded-xl font-mono text-sm placeholder-gray-500 focus:outline-none focus:bg-cayenne focus:text-white transition-colors"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-yellow-100 text-darkteal border-2 border-border-color rounded-xl font-mono text-sm placeholder-gray-500 focus:outline-none focus:bg-cayenne focus:text-white transition-colors"
              placeholder="••••••••"
            />
          </div>
