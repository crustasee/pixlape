...
export const ASSET_DATABASE: Record<CategoryType, AssetItem[]> = {
  design_app: [
    ...
    { id: 41, name: "Technical Spec Doc Kit", desc: "Markdown documentation templates for open source software projects.", size: "3.0 MB", os: ["all"], rating: "4.9", downloads: "16.4k", tag: "DEV", icon: "/icon/doc.svg", license: "MIT License", version: "v2.0" }
  ],
  multimedia: [
